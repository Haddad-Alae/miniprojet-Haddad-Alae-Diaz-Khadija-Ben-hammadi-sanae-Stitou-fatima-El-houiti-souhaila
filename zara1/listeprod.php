...
<a  style=" text-align:center"  href="ajouterprod.php" class="btn btn-primary" >ajouter un produit</a>
<br>
<br>
...
foreach($categories as $categories){
    ...
    <td>    
       ...
       <a href="supprimer_produit.php?id= <?php echo $categories['id']?>" onclick="return confirm(' voulez vous vraiment supprimer le produit <?php echo $categories['libelle']?> ')" class=" btn btn-danger">supprimer</a>
    </td>
