...
?>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item"  >
        <a class="nav-link " href="#sold" style="color:red;" > <i class="fa-solid fa-fire"></i> Soldes</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="#prod">Produits</a>
      </li>
...
<li class="nav-item">
  ...
  ?>
 <li class="nav-item">
        <a class="nav-link" href="index1.php"><i class="fa-solid fa-user"></i> connexion</a>
      </li>
...
define('PRODUCTS_COUNT', isset($_SESSION['cart'][$idUtilisateur]) ? count($_SESSION['cart'][$idUtilisateur]) : 0 );
  ...
  ?>
    <a href="cart.php" class="nav-item nav-link active">
       <h5 class="px-5 cart">
            <i class="fas fa-shopping-cart"></i> Panier <?php echo   PRODUCTS_COUNT;?>
