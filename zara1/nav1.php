...
<nav  class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="listsold.php"> liste produit soldé </a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="listeprod.php"> liste Produits</a>
      </li>
  
      <li class="nav-item">
         <a class="nav-link " href="listecat.php" id="navbardrop" data-toggle="dropdown">
