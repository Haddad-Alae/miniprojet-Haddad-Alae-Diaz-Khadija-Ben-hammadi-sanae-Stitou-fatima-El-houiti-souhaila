...
<a  style=" text-align:center"  href="ajoutercat.php" class="btn btn-primary" >ajouter une catégorie</a>
<br>
<br>
...
foreach($categories as $categories){
    ...
    <td>    
       ...
       <a href="supprimer_categorie.php?id= <?php echo $categories['id']?>" onclick="return confirm(' voulez vous vraiment supprimer lacategorie <?php echo $categories['libelle']?> ')" class=" btn btn-danger">supprimer</a>
    </td>
