...
<div class="container">
   ...
   <div class="row">
      ...
      <i class="fa-solid fa-comments-dollar"></i>
         <h2>Qualité et prix</h2>
         <p>Prix compétitifs sur plus de 100 millions de produits.</p>
      </div>
      <div class="service">
      <i class="fa-solid fa-truck"></i>
         <h2>Livraison internationale</h2>
         <p>Avec un site en 12 langues, nous livrons dans plus de 200 pays et régions.</p>
      </div>
      <div class="service">
      <i class="fa-solid fa-money-check-dollar"></i>
         <h2>Paiement sécurisé</h2>
         <p>Payez avec les méthodes les plus populaires et les plus sûres au monde.</p>
      </div> 
      <div class="service">
      <i class="fa-solid fa-file-invoice-dollar"></i>
         <h2>Achetez en toute confiance</h2>
         <p>Notre protection de l'acheteur vous protège du premier clic à la livraison.</p>
      </div>
      
      <div class="service">
      <i class="fa-solid fa-network-wired"></i>
         <h2>Centre d'aide</h2>
         <p>Assistance 24/7 pour répondre à toutes vos questions</p>
      </div> 
   </div>
...
<div>
  <a href="sold.php"> 
   <img src="images/soldd.jpeg"  id="sold">
   </a>
</div>
