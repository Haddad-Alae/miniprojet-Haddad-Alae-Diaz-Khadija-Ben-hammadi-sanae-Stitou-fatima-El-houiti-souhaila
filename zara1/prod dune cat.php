...
?>
 ...
 $sqlState = $pdo->prepare('SELECT * FROM sold WHERE id_categorie=?');

 $sqlState->execute([$id]);
 $solds = $sqlState->fetchAll( PDO::FETCH_OBJ);
...
<div    id="gallery" >
  ...
  <div class="card-body">
  <a href="detail_prod.php?id=<?php echo $idsold ?>" >afficher les details</a>
