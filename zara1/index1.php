        ...
        <div class="card-body">
            ...
            <div class="alert alert-danger alert-dismissible fade show" 
             role="alert">Incorrect username or password.</div> -->
                    ...
                    //redircetion
                     ...
                     //fin de inscribtion POUR user
                        ...
                        ?>
                         ...
                         Nom et  Mot de Passe sont obligatoires
              ...
              <span style=" padding: 20px ;">vous êtes déjà inscrit ?<a href="connexion_user.php"> connexion</a></span>
                    <br>
                    <br>
                    <span style=" padding: 20px ;">vous êtes un admin  ?<a href="conadminst.php"> connexion_admin</a></span>
